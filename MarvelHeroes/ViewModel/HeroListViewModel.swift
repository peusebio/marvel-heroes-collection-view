...
final class HeroListViewModel {
    ...
    init(request: HeroListRequest, delegate: HeroListViewModelDelegate, limit: Int){
...
//        let endIndex = heroes.count
            ...
            //for i in startIndex..<endIndex {
                ...
                if let imageData = try? Data(contentsOf: url){
                    DispatchQueue.main.async {
                        ...
                        self?.delegate?.addThumbnailToCell(cellItemIndex: heroIndex, thumbnailData: imageData)
                    }
                }
            //}
        }
    ...
    func prepareSearch (searchText: String){
